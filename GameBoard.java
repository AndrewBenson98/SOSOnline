...
//If its our turn
   ...
   // while (ai.myTurn(pieces) && !isBoardFull(pieces)) {
   // check(pieces, ai.getLastX(), ai.getLastY(), ai.getLastChar(),
   // true);
   //
   // game.repaint();
   //
...
//     System.out.println(nw.getY());
//     System.out.println(nw.getC());
     playTurn(pieces, nw.getX(), nw.getY(), nw.getC());
     //pieces[nw.getX()][nw.getY()] = nw.getC();
     ...
     {
      //System.out.println("Points Gained : " +check(pieces, nw.getX(), nw.getY(), nw.getC(), false));
   ...
   // while (ai2.myTurn(pieces) && !isBoardFull(pieces)) {
   //
   // check(pieces, ai2.getLastX(), ai2.getLastY(),
   // ai2.getLastChar(), false);
   //
   // game.repaint();
   //
   // // Delay
